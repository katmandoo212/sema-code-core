...
export async function addMarketplaceFromGit(repo: string): Promise<MarketplacePluginsInfo> {
  return getPluginsManager().addMarketplaceFromGit(repo)
}

export async function addMarketplaceFromDirectory(dirPath: string): Promise<MarketplacePluginsInfo> {
  return getPluginsManager().addMarketplaceFromDirectory(dirPath)
}

export async function updateMarketplace(marketplaceName: string): Promise<MarketplacePluginsInfo> {
  return getPluginsManager().updateMarketplace(marketplaceName)
}

export async function removeMarketplace(marketplaceName: string): Promise<MarketplacePluginsInfo> {
  return getPluginsManager().removeMarketplace(marketplaceName)
}
...
export async function installPlugin(
  ...
  return getPluginsManager().installPlugin(pluginName, marketplaceName, scope, projectPath)
}
...
export async function uninstallPlugin(
  ...
  return getPluginsManager().uninstallPlugin(pluginName, marketplaceName, scope, projectPath)
}
...
export async function enablePlugin(
  ...
  return getPluginsManager().enablePlugin(pluginName, marketplaceName, scope, projectPath)
}
...
export async function disablePlugin(
  ...
  return getPluginsManager().disablePlugin(pluginName, marketplaceName, scope, projectPath)
}
...
export async function updatePlugin(
  ...
  return getPluginsManager().updatePlugin(pluginName, marketplaceName, scope, projectPath)
}

export async function refreshMarketplacePluginsInfo(): Promise<MarketplacePluginsInfo> {
  return getPluginsManager().refreshMarketplacePluginsInfo()
}

export async function getMarketplacePluginsInfo(): Promise<MarketplacePluginsInfo> {
  return getPluginsManager().getMarketplacePluginsInfo()
}
