...
- **核心概念**
  ...
  - 工具系统
    ...
    - 内置工具
      ...
      - [网页抓取工具 WebFetch](wiki/core-concepts/tool-system/built-in-tools/webfetchtool)
      ...
      - [任务创建工具 TaskCreate](wiki/core-concepts/tool-system/built-in-tools/taskcreatetool)
      - [任务查询工具 TaskGet](wiki/core-concepts/tool-system/built-in-tools/taskgettool)
      - [任务列表工具 TaskList](wiki/core-concepts/tool-system/built-in-tools/tasklisttool)
      - [任务更新工具 TaskUpdate](wiki/core-concepts/tool-system/built-in-tools/taskupdatetool)
      - [定时任务创建工具 CronCreate](wiki/core-concepts/tool-system/built-in-tools/croncreatetool)
      - [定时任务删除工具 CronDelete](wiki/core-concepts/tool-system/built-in-tools/crondeletetool)
      - [定时任务列表工具 CronList](wiki/core-concepts/tool-system/built-in-tools/cronlisttool)
